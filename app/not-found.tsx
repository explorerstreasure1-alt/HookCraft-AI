      ...
      <div className="relative text-center">
        <div className="inline-flex mb-6 relative">
          ...
          <div className="relative w-12 h-12 rounded-lg bg-gradient-to-br from-[#d4af37] to-[#8b6914] flex items-center justify-center text-[#0a0a0f] font-black text-xl shadow-[0_0_25px_rgba(212,175,55,0.4)]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M4 4h7v7H4V4zm9 0h7v7h-7V4zm-9 9h7v7H4v-7zm9 0h7v7h-7v-7z" fill="currentColor"/></svg>
          </div>
        </div>
        <h1 className="text-6xl font-black text-white mb-4">404</h1>
        <p className="text-zinc-400 text-lg mb-8">Page not found. The hook you're looking for doesn't exist.</p>
        <Link href="/" className="inline-flex gold-shimmer text-[#0a0a0f] font-bold px-8 py-4 rounded-full text-sm uppercase tracking-wider">
          Back to Home
        </Link>
      </div>
    </div>
